...
export default function AnimTesting() {
  ...
  return (
    <>
      ...
      <div
        ref={ref2}
        className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-stone-950"
      >
        <motion.h1
          style={{ y: textY2 }}
          className="relative z-10 w-full text-balance text-center text-7xl font-bold text-white md:text-9xl"
        >
