...
export default function AboutMeSection() {
  ...
  const SubHeader = ({ text }: { text: string }) => {
    return (
      <h3 className="border-b border-white/10 bg-stone-900 py-32 text-center text-3xl font-bold text-stone-300 md:text-5xl">
        {text}
      </h3>
    );
  };
  ...
  const Intro = () => {
    ...
    return (
      <div className="flex flex-col border border-white/10 bg-stone-950 md:flex-row md:items-center md:bg-transparent lg:mx-auto lg:w-2/3">
  ...
  const GoalContainer = ({
    ...
    return (
      <div className="flex h-[80vh] flex-col justify-center border-b border-white/10 bg-stone-950">
  ...
  const ToolList = () => {
    ...
    return (
      <div className="flex flex-col justify-evenly border-y border-white/10">
        ...
        <div className="grid grid-cols-2 gap-16 border-y border-white/10 bg-stone-950 p-8 md:grid-cols-6 md:px-0 md:py-32 lg:grid-cols-12 lg:gap-4">
  ...
  return (
    <section>
      <div className="flex min-h-screen flex-col justify-center border-y border-white/15">
