...
export default function SectionHeader({ section, title }: SectionHeaderProps) {
  return (
    <div className="mb-16 flex flex-col items-center justify-center gap-2 md:mb-32">
      ...
      <h2 className="mx-auto text-balance bg-gradient-to-b from-stone-100 to-stone-500 bg-clip-text p-1 text-center text-4xl font-bold text-transparent md:text-6xl lg:w-1/2">
        {title}
      </h2>
    </div>
  );
